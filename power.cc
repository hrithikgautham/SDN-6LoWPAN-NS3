 ...
 */
// code for printing receiving packet
...
{
  NS_LOG_UNCOND (Simulator::Now ().GetSeconds ()
                 << "Old energy: " << oldValue << "; Total energy consumed by radio = " << totalEnergy << "J");
}
...
main (int argc, char *argv[])
{
  ...
  Inet6SocketAddress remote = Inet6SocketAddress (Ipv6Address::GetBroadcast (), 80);
